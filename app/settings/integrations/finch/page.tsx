    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-6 py-10">
        ...
        <section className="flex flex-col gap-6 rounded-2xl border bg-card p-8 shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-3"><a href="https://dashboard.tryfinch.com/signup" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2.5 font-medium text-primary-foreground hover:opacity-90">Create Finch account <ExternalLink className="size-4" /></a><a href="https://www.tryfinch.com/" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-primary hover:underline">Open Finch website</a></div>
        </section>
      </main>
    </div>
  )
