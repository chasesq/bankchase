...
function IssueCardContent() {
  ...
  const [issuedCard, setIssuedCard] = useState<{ lastFour: string; number: string; cvv: string; expiry: string; accountId: string } | null>(null)
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setIssuedCard({ lastFour: data.card.lastFour, number: data.cardDetails.cardNumber, cvv: data.cardDetails.cvv, expiry: data.cardDetails.expiry, accountId: selectedAccountId })
