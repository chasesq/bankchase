    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/20 to-accent/20 dark:from-primary/10 dark:to-accent/10">
        <div className="flex flex-col items-center gap-4">
          <Image src="/images/bankchase-logo.png" alt="BankChase" width={80} height={80} className="rounded-xl shadow-lg" priority loading="eager" />
          <span className="text-2xl font-bold tracking-wide text-foreground">BANKCHASE</span>
