        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-12 py-10 sm:gap-16">
          ...
          <section className="w-full max-w-xl rounded-md border border-[#aeb4bb] bg-white shadow-[0_3px_12px_rgba(0,0,0,.22)]">
            <div className="p-6 sm:p-9">
              ...
              {!isSignUp && <Link href="/demo" className="mt-4 flex items-center justify-center gap-2 rounded-md border border-[#0868b8] px-4 py-3 text-center font-semibold text-[#064b7c] transition hover:bg-[#eef7ff]"><span aria-hidden="true">✦</span>Explore the Mercury Demo</Link>}
            </div>
